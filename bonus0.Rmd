...
# 	# print(totalTime)
# 	# print(timeStepPerDriftUpdate)
# 	print(totalTime/timeStepPerDriftUpdate)
# 	print(trunc(totalTime/timeStepPerDriftUpdate))
# 	
# 
# 	timestampsList <- c(timestampsList, newTimes)
# 	nextL = length(timestampsList)
# 
...
# 	}
# 	print(paste(prevL, separator, nextL , separator, length(timestampsList)))
# 	timestampsList
# 	
# }
# 
